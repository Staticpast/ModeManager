...
# ModeManager Plugin Build and Deploy Script
...
readonly PLUGIN_NAME="ModeManager"
readonly PLUGIN_ARTIFACT_ID="ModeManager"

# GitHub configuration
readonly GITHUB_REPO="Staticpast/ModeManager"
...
Build and deploy the ModeManager plugin with intelligent change detection.
...
main() {
    ...
    log_info "Starting ModeManager plugin build and deployment..."
